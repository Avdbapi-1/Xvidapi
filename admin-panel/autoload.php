        ...
        <div class="navigation">
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    <?php if ($pt->user->admin == 1 || CheckHaveMultiPermission(['payment-settings','ads-settings','bank-receipts','manage-website-ads','manage-user-ads','payment-requests','manage-currencies','earnings'])) { ?>
                    <li <?php echo ($page == 'payment-settings' || $page == 'ads-settings' || $page == 'bank-receipts' || $page == 'manage-website-ads' || $page == 'manage-user-ads' || $page == 'earnings' || $page == 'payment-requests') ? 'class="open"' : ''; ?>>
                        <a href="#">
                            <span class="nav-link-icon">
                        ...
                        <ul <?php echo ($page == 'payment-settings' || $page == 'ads-settings' || $page == 'bank-receipts' || $page == 'manage-website-ads' || $page == 'manage-user-ads' || $page == 'payment-requests' || $page == 'manage-currencies') ? 'style="display: block;"' : ''; ?>>
                    ...
                    <?php if ($pt->user->admin == 1 || CheckHaveMultiPermission(['avdbapi'])) { ?>

                    <li>
                        <a <?php echo ($page == 'avdbapi') ? 'class="active"' : ''; ?>  href="<?php echo PT_LoadAdminLinkSettings('avdbapi'); ?>" data-ajax="?path=avdbapi">
                            <span class="nav-link-icon">
                                <i class="material-icons">backup</i>
                            </span>
                            <span>Import AVDB API</span>
                        </a>
                    </li>
                    <?php } ?>

                    <?php if ($pt->user->admin == 1 || CheckHaveMultiPermission(['xvidapi'])) { ?>

                    <li>
                        <a <?php echo ($page == 'xvidapi') ? 'class="active"' : ''; ?>  href="<?php echo PT_LoadAdminLinkSettings('xvidapi'); ?>" data-ajax="?path=xvidapi">
                            <span class="nav-link-icon">
                                <i class="material-icons">backup</i>
                            </span>
                            <span>Import XVID API</span>
                        </a>
                    </li>
                    <?php } ?>
                    ...
                    <li>
                        <a href="https://help.avdbapi.com" target="_blank">
                            <span class="nav-link-icon">
                                <i class="material-icons">more_vert</i>
                            </span>
                            <span>FAQs & Docs</span>
                     ...
                     <a class="pow_link" href="https://whatsohot.com/" target="_blank">
                        <p>Powered by</p>
                        <img src="https://whatsohot.com/themes/default/img/logo-light.png?cache=<?php echo($pt->config->logo_cache) ?>">
