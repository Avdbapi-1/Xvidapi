...
if (!empty($_POST['install'])) {
   ...
   // Normalize site URL to always use https and no trailing slash
   if (!empty($_POST['site_url'])) {
      $_POST['site_url'] = trim($_POST['site_url']);
      if (!preg_match('~^https?://~i', $_POST['site_url'])) {
          $_POST['site_url'] = 'https://' . $_POST['site_url'];
      }
      $_POST['site_url'] = preg_replace('~^http://~i', 'https://', $_POST['site_url']);
...
// Site URL
$site_url = "' . $_POST['site_url'] . '"; // e.g (https://whatsohot.com) If you have enabled SSL please use https
          ...
          $json['ssl_privatekey_full_path'] = '';
           ...
           $query_one .= mysqli_query($con, "INSERT INTO `users` (
            ...
            VALUES ('" . mysqli_real_escape_string($con, $_POST['admin_username']). "', '" . mysqli_real_escape_string($con, sha1($_POST['admin_password'])) . "','" . mysqli_real_escape_string($con, $_POST['siteEmail']) . "'
                ,'1', '1', '00/0000')");
           $success = 'Xvidcms successfully installed, please wait ..';
        } else {
          $ServerErrors[] = "Error found while installing, please contact us.";
        }
      }
...
<html>
	...
	<head>
		...
		<title>Xvidcms | Installation</title>
...
?>
    ...
    <tbody>
      <tr>
        <td>PHP 7.1+</td>
        <td>Required PHP version 7.4</td>
      ...
      <tr>
        <td>whatsohot.sql</td>
        <td>Required whatsohot.sql for the installation <small>(Located in ./Script)</small></td>
      ...
      <tr>
        ...
        <td><?php echo ($is_writable_json == true) ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Executable</font>' : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Not executable</font>'?></td>
                                ...
                                <?php } else if ($page == 'finish') { ?>
									<div class="req">
										<p>Congratulations! Xvidcms script has been successfully installed and your website is ready.</p>
                                    ...
                                    <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="help-block">Enter "whatsohot" purchase code, you can get it from <a href="https://whatsohot.com">Here</a>.</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              ?>
                                                ...
                                                <span class="help-block">Examples: <br>https://whatsohot.com<br> https://www.whatsohot.com<br> https://subdomain.whatsohot.com<br> https://whatsohot.com/subfolder<br> If you have enabled ssl please use https:// </span>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="form-group">
