	...
	if (!in_array(true, $request)) {
	    ...
	    if (!empty($video_data) && !empty($comm_data)) {
	        ...
	        if ($insert_reply) {
	            ...
	            $data = array('status' => 400, 'error' => 'failed_to_insert_reply');
	        }
	    }
	    else {
	        $data = array('status' => 400, 'error' => 'video_or_comment_not_found');
	    }
	}
...
if ($first == 'article') {
	...
	if (!in_array(true, $request)) {
	    ...
	    if (!empty($post_data) && !empty($comm_data)) {
	        ...
	        $data = array('status' => 400, 'error' => 'post_or_comment_not_found');
	    }
	}
...
if ($first == 'activity') {
	...
	if (!in_array(true, $request)) {
	    ...
	    if (!empty($post_data) && !empty($comm_data)) {
	        ...
	        $data = array('status' => 400, 'error' => 'activity_or_comment_not_found');
	    }
	}
